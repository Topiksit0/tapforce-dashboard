import UploadDataButton from "../subcomponents/UploadDataButton"
            ...
            <div className="h-full p-5 overflow-y-auto bg-white border-r border-r-[#ebebeb] ">
                <ul className="space-y-2 font-medium">
                    ...
                    <div className="space-y-10">
                        <li>
                            <a href="#" className="flex items-center p-2 py-3 text-gray-900 rounded-lg bg-slate-200 w-full h-full">
